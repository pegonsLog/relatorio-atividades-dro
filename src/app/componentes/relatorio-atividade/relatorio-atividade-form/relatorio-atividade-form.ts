...
import { RelatorioAtividadeService } from '../../../services';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-relatorio-atividade-form',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './relatorio-atividade-form.html',
  styleUrl: './relatorio-atividade-form.scss'
})
export class RelatorioAtividadeForm implements OnInit {
  @Input() atividade?: RelatorioAtividade;
  @Input() idRelatorio!: number;
  @Input() isEditMode = false;
  @Output() formSubmit = new EventEmitter<RelatorioAtividade>();
  ...
  constructor(
    ...
    private atividadeService: RelatorioAtividadeService
  ) {
  ...
  onSubmit(): void {
    if (this.atividadeForm.valid) {
      ...
      const atividadeData: RelatorioAtividade = {
        ...formData,
